...
let likesYourPostMessage = "likes playing"
...
let gameName = "Lord of the rings"

let total = username + " " + likesYourPostMessage + " " + gameName
...
let combinedMessage = fullName + " " + likesYourPostMessage
/*:
