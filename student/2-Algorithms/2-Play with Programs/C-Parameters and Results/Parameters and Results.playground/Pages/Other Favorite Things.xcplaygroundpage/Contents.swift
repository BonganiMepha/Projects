 ...
 */
func favouriteWorkout() {
let categoryOfThing = "workout"
let favourite = "squads"
print("my favourite \(categoryOfThing) is \(favourite)")
}

favouriteWorkout()

func favouriteSupplement() {
    let categoryThing = "TNT"
    let favouriteFlavour = "chocolate mousse"
    print("my favourite \(categoryThing) is \(favouriteFlavour)")
}
/*:
