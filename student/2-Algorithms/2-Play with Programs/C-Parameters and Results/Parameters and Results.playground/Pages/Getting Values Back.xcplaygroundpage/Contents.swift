...
func kilogramsFromProtein(eachProteinScoop: Int, numberOfKilograms: Int) -> String {
    let currentweight = 10000
    let kilogramsPerProteinScoop = 5
    let totalGains = currentweight * eachProteinScoop - numberOfKilograms * kilogramsPerProteinScoop
    
    return "If your \(numberOfKilograms) kilograms are \(eachProteinScoop) scoops each, you ll have \(totalGains) kgs gained"
}
kilogramsFromProtein(eachProteinScoop: 10, numberOfKilograms: 5)
/*:
